              ...
              <div className="flex items-center md:space-x-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-80 md:w-96 max-h-[70vh] flex flex-col dark:bg-gray-900 dark:border-none" align="end">
                    ...
                    <DropdownMenuItem onClick={() => window.location.href = '/clientarea/notifications'} className="justify-center cursor-pointer text-indigo-600 dark:text-indigo-400 hover:underline">
